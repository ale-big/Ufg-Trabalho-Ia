...
class SentimentAnalysisView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            prompt = (
                f"Realize uma análise profunda e detalhada do sentimento "\
                f"expresso do seguinte texto em português brasileiro de um cliente: '{text}'. "
                f"classifique e retorne apenas 'positivo', 'neutro' ou 'negativo'."
            )
